                  ...
                  <div className="px-6 lg:px-[24px] flex flex-col gap-[16px] lg:gap-[8px] flex-1 overflow-visible lg:overflow-y-auto min-h-0">
                    ...
                    <div className="flex flex-col min-[360px]:flex-row gap-[16px] lg:gap-[12px] w-full">
                      ...
                      <div className="flex-[128] shrink-0 relative">
                        <label className="hidden md:block font-sans font-medium text-[14px] leading-[20px] text-[#404040] mb-1.5 lg:mb-0.5">
                          Employment status
                        </label>
                        <label className="block md:hidden font-sans font-medium text-[14px] leading-[20px] text-[#404040] mb-1.5 lg:mb-0.5">
                          Status
                        </label>
