...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[96vh] landscape:h-[500px] sm:h-[610px] md:h-[660px] lg:h-[720px] xl:h-[780px] 2xl:h-[840px] overflow-hidden bg-white">
      ...
      <div
        className="absolute inset-0 bg-no-repeat bg-[size:auto_125%] landscape:bg-cover sm:bg-cover select-none pointer-events-none z-0"
        style={{
      ...
      <div className="relative z-20 w-full max-w-[1474px] mx-auto flex flex-col items-center text-center pt-[96px] landscape:pt-[70px] sm:pt-[110px] md:pt-[120px] lg:pt-[100px] px-6">
        {/* Main Headline */}
        <h1 className="font-['Cal_Sans'] font-normal text-[36px] landscape:text-[28px] sm:text-[38px] md:text-[44px] lg:text-[50px] xl:text-[56px] 2xl:text-[70px] leading-[1.08] text-[#4879FF] text-center max-w-[1200px] animate-fade-in">
          Upskilling Tomorrow&apos;s <br /> CFA Charterholder
        </h1>

        {/* Subtitle */}
        <p className="font-sans font-normal text-[11px] landscape:text-[11px] sm:text-[12px] md:text-[13px] lg:text-[15px] xl:text-[17px] 2xl:text-[18px] leading-[1.35] text-center text-[#2f2f2f] max-w-[960px] w-full px-3 sm:px-4 mt-3 landscape:mt-1 sm:mt-2 tracking-tight">
