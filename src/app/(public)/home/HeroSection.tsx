...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[96vh] sm:h-[610px] md:h-[660px] lg:h-[720px] xl:h-[780px] 2xl:h-[840px] overflow-hidden bg-white hero-section-landscape">
      ...
      <div
        className="absolute inset-0 bg-no-repeat bg-[size:auto_125%] sm:bg-cover select-none pointer-events-none z-0 hero-image-landscape"
        style={{
      ...
      <div
        className="absolute top-0 left-0 right-0 h-[60%] sm:h-[56%] md:h-[52%] z-10 pointer-events-none hero-top-fader-landscape"
        style={{
      ...
      <div className="relative z-20 w-full max-w-[1474px] mx-auto flex flex-col items-center text-center pt-[96px] sm:pt-[110px] md:pt-[120px] lg:pt-[100px] px-6 hero-content-landscape">
        ...
        {/* Subtitle */}
        <p className="font-sans font-normal text-[11px] sm:text-[12px] md:text-[13px] lg:text-[15px] xl:text-[17px] 2xl:text-[18px] leading-[1.35] text-center text-[#2f2f2f] max-w-[960px] w-full px-3 sm:px-4 mt-3 sm:mt-2 tracking-tight hero-subtitle-landscape">
        ...
        {/* Action Buttons */}
        <div className="mt-4 flex flex-row gap-3 sm:gap-5 w-full max-w-[340px] sm:max-w-none justify-center px-4 sm:px-0 hero-buttons-landscape">
          <Link
