  ...
  return (
    <section className="relative w-full px-6 pt-12 md:pt-20 flex flex-col items-center bg-white z-10 px-6 md:px-8 lg:px-12">
      ...
      <div className="flex flex-col gap-[45px] w-full max-w-[1539px]">
        ...
        <div className="relative w-full lg:h-[117px] bg-brand-blue text-white rounded-[28px] flex flex-col md:flex-row items-center overflow-hidden shadow-sm transition-all duration-300 hover:translate-y-[-2px]">
          ...
          <div className="w-full h-full flex flex-col lg:flex-row lg:items-center pt-[90px] md:pt-6 lg:pt-0 pb-6 lg:pb-0 pl-6 md:pl-[197px] pr-6 md:pr-10 gap-4 lg:gap-[40px]">
