export default function EligibilitySection() {
  return (
    <section className="relative w-full px-6 py-8 md:py-12 flex justify-center z-10">
      ...
      <div className="max-w-[1503px] w-full grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch md:items-center">
        
        {/* Card 1: Complete a valid bachelor's degree */}
        <div className="flex flex-col justify-between p-8 md:p-10 bg-brand-blue text-white rounded-[32px] shadow-sm transition-all duration-300 hover:translate-y-[-4px] min-h-[350px] md:h-[380px] md:self-center">
          <div>
        ...
        <div className="flex flex-col justify-between p-8 md:p-10 bg-white text-near-black rounded-[32px] border border-dashed border-brand-blue shadow-sm transition-all duration-300 hover:translate-y-[-4px] min-h-[380px] md:h-[441px]">
          <div>
            <div className="w-12 h-12 mb-6 rounded-xl border border-dashed border-brand-blue flex items-center justify-center">
              {/* Graduation Cap Icon */}
